...
ActiveRecord::Schema[8.1].define(version: 2025_11_16_184513) do
  ...
  create_table "import_batches", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "user_id", null: false
    t.index ["import_template_id"], name: "index_import_batches_on_import_template_id"
  ...
  create_table "import_templates", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "user_id", null: false
    t.index ["user_id", "name"], name: "index_import_templates_on_user_id_and_name", unique: true
